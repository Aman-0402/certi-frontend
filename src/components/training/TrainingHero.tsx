...
import heroImg from '../../assets/training-hero.webp'

const TRUST_POINTS = ['Secure Assessments', 'Certification Vouchers', 'Verifiable Credentials']
      ...
      <div className="relative mx-auto grid max-w-[1600px] items-center gap-10 px-6 py-20 sm:px-10 lg:grid-cols-[50%_50%] lg:px-16 lg:py-24">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="mt-5 max-w-lg text-lg text-navy/60">
            Collaborate with CertiByt to provide your learners access to secure professional
