const STEPS = [
  {
    ...
    desc: 'Complete your selected certification assessment through CertiByt.',
  },
  {
    number: '02',
    title: 'Meet Certification Requirements',
    desc: 'Achieve the required assessment result for the certification.',
  },
  {
    number: '03',
    title: 'Receive Your Digital Credential',
    desc: 'When certificate issuance is available for the certification, your digital certificate is generated.',
  },
  {
    number: '04',
    title: 'Share and Verify',
    desc: 'Use the Certificate ID to independently verify the credential through CertiByt.',
  },
] as const

const FLOW_NODES = [
  { label: 'Assessment', icon: 'assessment' },
  { label: 'Verified Result', icon: 'result' },
  { label: 'Digital Certificate', icon: 'certificate' },
  { label: 'Verification Shield', icon: 'shield' },
] as const
    ...
    <section className="bg-royal/5">
      <div className="mx-auto max-w-[1600px] px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-bold text-navy sm:text-3xl">Your Certification Achievement, Digitally Recognized</h2>
          <p className="mt-4 text-navy/60">
            When certification requirements are successfully met, eligible candidates can
            receive a digital credential that becomes part of the CertiByt certification
            ecosystem.
          </p>
        </div>
